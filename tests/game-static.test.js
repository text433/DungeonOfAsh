...
for (const marker of [
  ...
  "renderMinimap", "openSmith", "upgradeWeapon", "ensureSound", "sound.step()", "createBuffer", "updateCarriedWeapon", "createAttackFx", "addLavaFall",
...
if (!html.includes('<script src="game.js?v=38"></script>')) throw new Error("HTML neielādē jaunāko spēles kodu");
