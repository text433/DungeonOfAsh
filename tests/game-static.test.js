...
if (!html.includes('<script src="game.js?v=69"></script>')) throw new Error("HTML neielādē jaunāko spēles kodu");
if (html.includes('id="minimap-label"') || html.includes('KARTE · SIENAS')) {
  throw new Error("Minikartē joprojām redzams sienu teksts");
}
if (!html.includes('<link rel="stylesheet" href="style.css?v=69" />')) throw new Error("HTML neielādē jaunāko HUD noformējumu");
