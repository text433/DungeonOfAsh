...
for (const marker of [
  ...
  "setOrigin(0.5, 0.95).setScale(0.74)", "facingLeft ? 360 - pose.angle",
...
if (!html.includes('<script src="game.js?v=34"></script>')) throw new Error("HTML neielādē jaunāko spēles kodu");
